//! Interactive ACP permission approval ("ask every time" mode).
//!
...
//! the user's choice via `agent_respond_permission`, and only then replies to
//! the agent. A timeout falls back to cancelling the request.
