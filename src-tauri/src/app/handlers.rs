...
macro_rules! common_commands {
    ($($extra:path),* $(,)?) => {
        ::tauri::generate_handler![
            ...
            crate::features::settings::commands::settings_path,
            crate::features::settings::commands::host_identity,
            crate::features::agent::commands::agent_list_agents,
            crate::features::agent::commands::agent_list_templates,
            ...
            crate::features::agent::commands::agent_discover,
            ...
            crate::features::trash::commands::path_untrash,
            ...
            crate::features::import::commands::lookup_import,
            crate::features::import::commands::lookup_import_batch,
            crate::features::import::commands::lookup_translator_config,
            ...
            crate::features::catalog::commands::paper_delete,
...
pub fn attach_handlers(builder: tauri::Builder<tauri::Wry>) -> tauri::Builder<tauri::Wry> {
    #[cfg(not(target_os = "ios"))]
    {
        builder.invoke_handler(common_commands![
            ...
            crate::features::remote::commands::remote_paper_delete,
            ...
            crate::features::remote::commands::remote_agent_discover,
