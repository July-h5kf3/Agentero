...
/**
 * Recycle Bin browser: list, restore, or permanently delete items previously
 * moved into `.agentero/.trash/`. Restores files + catalog rows via the Host.
 */
export function RecycleBinDialog({
	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			...
			>
				<DialogHeader>
					<DialogTitle>{t("recycleBin.title")}</DialogTitle>
				</DialogHeader>
