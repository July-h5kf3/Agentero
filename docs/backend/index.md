...
- **Zotero Connector 兼容服务**（规划）：本机 `127.0.0.1:23119` 兼容官方浏览器扩展保存协议 → 当前 Vault；与 Zotero 桌面端端口互斥；见 [`connector.md`](connector.md)。
...
- [`connector.md`](connector.md)：Zotero Connector 兼容 HTTP 服务（方案一：本机 23119；设计中）。
