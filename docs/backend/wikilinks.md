...
**代码位置**：`src-tauri/src/services/wiki/` · `src-tauri/src/commands/graph.rs` · `src/components/layout/sidebar/backlinks-panel.tsx` · `src/hooks/use-vault-file-events.ts`
...
- `src/components/layout/sidebar/graph-panel.tsx`
